export function CardCTAsWithIconsSection() {
  return (
    <section>
      <div className="mx-auto max-w-screen-xl py-16 md:py-18 lg:py-20 space-y-8 md:space-y-10 lg:space-y-12">
        ...
        <div className="max-w-5xl  px-4 lg:px-0 flex flex-col lg:flex-row items-center  justify-center  gap-4 mx-auto">
          <h2 className="text-3xl md:text-4xl   lg:text-right text-center font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white">
            Think Your Business Can't Afford a Professional Start?
          </h2>
          <p className="text-base md:text-xl  font-normal text-gray-500 dark:text-gray-400 lg:text-left text-center ">
