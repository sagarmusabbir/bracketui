  ...
  return (
    <section className="pb-10 sm:pb-12 lg:pb-14 xl:pb-16 pt-20 sm:pt-24 lg:pt-28 xl:pt-32 bg-[radial-gradient(#f0f0f0_1px,transparent_1px)] dark:bg-[radial-gradient(#1e2026_1px,transparent_1px)] [background-size:16px_16px]">
      <Bracket fluid centered padding="medium">
        <div className="sm:mx-auto max-w-screen-xl">
          <div className="flex flex-col items-start sm:items-center space-y-10 md:space-y-12 lg:space-y-14">
            <h1 className="text-[2.55rem]/[1.1] font-black md:text-5xl/[1.1] lg:text-6xl/[1.1] text-left bg-gradient-primary dark:bg-gradient-primary-dark text-transparent bg-clip-text sm:text-center lg:max-w-screen-md xl:max-w-screen-lg sm:max-w-lg md:max-w-screen-sm max-w-md capitalize">
              Next.js Web Development for UK Agencies & Startups
            </h1>
            ...
            <p className="text-primary-950/80 dark:text-primary-200/70 font-light text-base/[1.6] md:text-lg/[1.75rem] lg:text-xl/[1.85rem] lg:max-w-screen-md sm:max-w-lg md:max-w-screen-sm text-left sm:text-center xl:max-w-[900px] backdrop-blur-sm">
              We build fast, SEO-optimized websites using Next.js and
              TailwindCSS. Our custom React component library delivers minimal,
              professional design that’s hard to outsource without an in-house
              team.
            </p>
