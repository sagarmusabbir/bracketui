...
const iconMap: Record<string, React.ReactNode> = {
  ...
  SiTailwindcss: (
    <SiTailwindcss key="tailwind" size={30} title="Tailwind CSS" />
  ),
  ...
  SiAdobeillustrator: (
    <SiAdobeillustrator key="illustrator" size={30} title="Adobe Illustrator" />
  ),
  SiFramer: <SiFramer key="framer" size={30} title="Framer" />,

  // Analytics & SEO
  SiGoogleanalytics: (
    <SiGoogleanalytics key="analytics" size={30} title="Google Analytics" />
  ),
  SiGooglesearchconsole: (
    <SiGooglesearchconsole
      key="searchconsole"
