...
const categories = [
  {
    ...
    services: [
      ...
      },
      {
        ...
        description:
          "Optimize web applications for speed, SEO, and user experience.",
    ...
    services: [
      {
        ...
        description:
          "Create high-converting landing pages that drive user engagement and actions.",
        features: [
      ...
      },
      {
        title: "Vector Design",
        description:
          "Create scalable logos, icons, and visual assets for brand consistency.",
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        title: "Performance Optimization",
        description:
          "Enhance website performance metrics for better user experience and SEO.",
        features: [
          "Speed Optimization",
          "Core Web Vitals",
          "Mobile Performance",
      ...
      },
      {
        ...
        description:
          "Build websites with SEO best practices implemented from the ground up.",
      ...
      },
      {
        ...
        description:
          "Implement and optimize Google services for better visibility and analytics.",
